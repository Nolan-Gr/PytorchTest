...
class Model:
    ...
    def plot_loss(count, train_loss, test_loss):
        plt.plot(count, train_loss, label="Train loss")
    ...
    X_train, y_train = X[:train_split], y[:train_split]  # on prend tout jusqu'à 80% de X et Y
    X_test, y_test = X[train_split:], y[train_split:]  # et les 20%
